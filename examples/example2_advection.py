...
def main():
    ...
    mgrit = Mgrit(problem=problem, tol=1e-8, cf_iter=1, nested_iteration=False, output_fcn=output_fcn, output_lvl=2)
    ...
    # Set up two-level MGRIT solver with FCF-relaxation without nested iterations and C-relaxation
    mgrit = Mgrit(problem=problem, omega=1.6, tol=1e-8, cf_iter=1, nested_iteration=False, output_fcn=output_fcn, output_lvl=2)
