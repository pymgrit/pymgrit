...
plt.grid(True)
plt.plot(t_4, diff_sol_69_sol_17, label='Absolute error sin 69k vs 17k', lw=2)
plt.plot(t_4, diff_sol_69_sol_4, label='Absolute error sin 69k vs 4k', lw=2)
...
plt.savefig("joule_losses_space_absolute_short.jpg", bbox_inches='tight')
plt.show()
...
ax = fig.add_subplot(1, 1, 1)
plt.grid(True)
plt.plot(t_4[1:], diff_sol_69_sol_17, label='Relative error sin 69k vs 17k', lw=2)
plt.plot(t_4[1:], diff_sol_69_sol_4, label='Relative error sin 69k vs 4k', lw=2)
...
plt.yticks(size=fonts, weight='bold')
plt.legend(loc='lower right', prop={'size': fonts})
plt.savefig("joule_losses_space_relative_short.jpg", bbox_inches='tight')
plt.show()
