...
if __name__ == '__main__':
    ...
    # plt.legend()
    # np.savez('machine_back_ua_pwm', first_ua=first_ua, second_ua=second_ua, ua=ua)
    # plt.savefig("machine_back_ua_pwm.jpg", bbox_inches='tight')
    # plt.show()
    #
    # fig = plt.figure(figsize=(12, 8))
    # ax = fig.add_subplot(1, 1, 1)
    ...
    # plt.legend()
    # np.savez('machine_back_ub_pwm', first_ub=first_ub, second_ub=second_ub, ub=ub)
    # plt.savefig("machine_back_ub_pwm.jpg", bbox_inches='tight')
    # plt.show()
    #
    # fig = plt.figure(figsize=(12, 8))
    # ax = fig.add_subplot(1, 1, 1)
    ...
    # plt.legend()
    # np.savez('machine_back_uc_pwm', first_uc=first_uc, second_uc=second_uc, uc=uc)
    # plt.savefig("machine_back_uc_pwm.jpg", bbox_inches='tight')
    # plt.show()
    #
    # fig = plt.figure(figsize=(12, 8))
    # ax = fig.add_subplot(1, 1, 1)
    ...
    # plt.legend()
    # np.savez('machine_i_pwm', ia=ia, ib=ib, ic=ic)
    # plt.savefig("machine_i_pwm.jpg", bbox_inches='tight')
    # plt.show()
    #
    # fig = plt.figure(figsize=(12, 8))
    # ax = fig.add_subplot(1, 1, 1)
    ...
    # plt.legend()
    # np.savez('stator_currents_pwm', stator_0=stator_0, stator_1=stator_1, stator_2=stator_2, stator_3=stator_3,
    #         stator_4=stator_4, stator_5=stator_5, stator_6=stator_6, stator_7 = stator_7)
    # plt.savefig("stator_currents_pwm.jpg", bbox_inches='tight')
    # plt.show()
