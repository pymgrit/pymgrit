...
#SBATCH --exclusive
#SBATCH -o machine_without_startup.%j.out
#SBATCH -e machine_without_startup.%j.err
...
date
mpirun --mca btl tcp,sm,self python3 -m mpi4py -m cluster_runs.run_machine_nonlinear_without_startup
date
