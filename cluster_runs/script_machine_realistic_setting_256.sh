...
#SBATCH --exclusive
#SBATCH -o machine_realistic_512.%j.out
#SBATCH -e machine_realistic_512.%j.out.err
...
date
mpirun --mca btl tcp,sm,self python3 -m mpi4py -m cluster_runs.run_machine_realistic_setting_256
date
