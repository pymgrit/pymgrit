...
if __name__ == '__main__':
    def output_fcn(self):
        now = 'induction_machine_jl_4k_nonlinear_6per_214_new'
    ...
    machine_3 = im_3kW.InductionMachine(nonlinear=True, pwm=False, grid='im_3kW_4k',
                                        t_start=0, t_stop=2 ** -3, nt=2 ** 9 + 1)
    machine_4 = im_3kW.InductionMachine(nonlinear=True, pwm=False, grid='im_3kW_4k',
