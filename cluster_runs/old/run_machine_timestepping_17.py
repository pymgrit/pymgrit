...
if __name__ == '__main__':
    def output_fcn(self):
        now = 'induction_machine_jl_timestepping_17'
    ...
    machine_0 = im_3kW.InductionMachine(nonlinear=False, pwm=True, grid='im_3kW_17k',
                                        t_start=0, t_stop=2 ** -8, nt=33)


    problem = [machine_0]
    transfer = []
    mgrit = mgrit_machine.MgritMachine(compute_f_after_convergence=True, problem=problem,
                                       transfer=transfer, it=1, nested_iteration=False, tol=1,
