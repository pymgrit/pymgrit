...
#SBATCH --exclusive
#SBATCH -o machine_test_sin_64k.%j.out
#SBATCH -e machine_test_sin_64k.%j.err
...
date
mpirun --mca btl tcp,sm,self python3 -m mpi4py -m cluster_runs.run_machine_test_sin_64k
date
