...
plt.grid(True)
plt.plot(t_4k_pwm[1:], diff_pwm_64_4, label='Absolute difference pwm 67k vs 4k', lw=2)
plt.plot(t_4k_pwm[1:], diff_pwm_64_16, label='Absolute difference pwm 67k vs 17k', lw=2)
...
ax = fig.add_subplot(1, 1, 1)
plt.grid(True)
plt.plot(t_4k_pwm[1:], diff_pwm_64_4, label='Relative difference pwm 67k vs 4k', lw=2)
plt.plot(t_4k_pwm[1:], diff_pwm_64_16, label='Relative difference pwm 67k vs 16k', lw=2)
