...
plt.grid(True)
plt.plot(t_4, diff_sol_69_sol_17, label='Absolute error sin 69k vs 1k7', lw=2)
...
ax = fig.add_subplot(1, 1, 1)
plt.grid(True)
plt.plot(t_4[1:], diff_sol_69_sol_17, label='Relative error sin 69 vs 17', lw=2)
plt.plot(t_4[1:], diff_sol_69_sol_4, label='Relative error sin 69 vs 4', lw=2)
