...
if __name__ == '__main__':
    heat = heat_equation.HeatEquation(x_start=0, x_end=2, nx=[101], t_start=0, t_stop=2, nt=101)
    mgrit = solver.MgritFas(problem=heat)
    mgrit.setup(lvl_max=3, m=2, it=3, tol=1e-7, nested_iteration=True, spatial_coarsening=False, spatial_max_lvl=0)
